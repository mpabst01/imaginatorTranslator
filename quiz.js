...
function showQuestion() {
  ...
  questionContainerDiv.append(renderButton(q.choiceA, q.btn.Id, "choice-a"));
  questionContainerDiv.append(renderButton(q.choiceB, q.btn.Id, "choice-b"));
  questionContainerDiv.append(renderButton(q.choiceC, q.btn.Id, "choice-c"));
  questionContainerDiv.append(renderButton(q.choiceD, q.btn.Id, "choice-d"));
...
function nextBtn() {
  nextContainerDiv.append(nextAttribute(btnId, type, name, id, value, onClick));
